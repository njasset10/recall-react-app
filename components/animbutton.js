  ...
  render() {
    return (
      <TouchableWithoutFeedback onPress={() => this._onPress()}>
        <Animatable.View ref="view" style={this.state.status ? styles.correctSelection : styles.unselectedButton}>
          <Text style={this.state.status ? styles.selectedText : styles.unselectedText }>{this.props.text}</Text>
        </Animatable.View>
      </TouchableWithoutFeedback>
    );
  }
